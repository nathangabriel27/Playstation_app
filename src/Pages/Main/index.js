...
import { TouchableOpacity, Text, View, Dimensions, StatusBar, ScrollView, ImageBackground, Image } from 'react-native';

import { TabView, SceneMap } from 'react-native-tab-view';
import Svg, { Path } from 'react-native-svg';
import styles from '../Main/styles';
import { dataUserProfile, consolesPlaystation } from '../../Constants/data'
...
export default function Main() {
  ...
  useEffect(() => {
    setTimeout(() => startLoopSvgSecundary(), 10)
  }, [translateSecundary])
        ...
        {consolesPlaystation.map((console, i) => {
          return (
            <TouchableOpacity
              ...
              onPress={() => console.log(console.uriPhotoCosole)}
            >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          <View style={styles.footerContainer}>
            <Text>Games para você</Text>
            <Text>Selecione um exclusivo da psn</Text>
            <Text>Ver mais</Text>
          </View>
        </View>
      </View>
